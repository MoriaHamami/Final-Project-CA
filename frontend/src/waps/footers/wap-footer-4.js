...
export const wapFooter4 = {
  ...
  info: {
    txt: { txt: ' Email Us: info@mysite.com   |   Tel: 123-456-7890   |   500 Terry Francois Street San Francisco, CA 94158', style: {fontSize: '0.8em'}, id: utilService.makeId(), type: 'txt' },
    btns: [
