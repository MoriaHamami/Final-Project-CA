...
export const wapForm4 = {
    ...
    info: {
        title: { txt: 'BE IN', style: { fontFamily: 'open-sans', fontSize: '1.1em', letterSpacing: '0.3em', lineHeight: '1.4em', color: 'white' }, id: utilService.makeId(), type: 'txt' },
        subtitle: { txt: 'TOUCH', style: { fontFamily: 'open-sans', fontSize: '2.8em', letterSpacing: '0.3em', lineHeight: '1.4em', color: 'white' }, id: utilService.makeId(), type: 'txt' },
        txt: { txt: 'Please fill your contact details below:', style: { fontSize: '1em', color: 'white' }, id: utilService.makeId(), type: 'txt' },
        inputs: [
