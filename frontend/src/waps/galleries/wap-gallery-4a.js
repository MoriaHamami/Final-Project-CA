...
export const wapGallery4A = {
    ...
    info: {
        title: {txt: 'OUR', type: 'txt', id: utilService.makeId(), style: {color:'black', fontSize:'1.1rem',letterSpacing: '0.3em'}, key: 'title'},
        subtitle: {txt: 'SERVICES', id: utilService.makeId(), type: 'txt', style: {color:'#34d1b6',letterSpacing: '0.3em', fontSize:'2.75rem'}, key: 'subtitle'},
        photos: [
            {
            ...
            },
            {
                ...
                title: { txt: 'CREATE STRATEGY', id: utilService.makeId(), style: {color:'black', fontSize:'1.1rem', lineHeight:'1.4em'}, type: 'txt', key: 'photos' },
