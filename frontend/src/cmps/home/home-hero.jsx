    ...
    return (
        <div className='hero-container'>
            ...
            <section className="home-page-hero">
                <div className='intro-container animate__animated animate__fadeInUpBig'>
                ...
                <a href='#home-preview'><span className={`material-symbols-outlined ${isDown ? 'expand down' : 'expand'}`}>expand_more</span></a>
            </section >
